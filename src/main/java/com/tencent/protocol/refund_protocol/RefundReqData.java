...
public class RefundReqData {
     ...
     */
    public RefundReqData(String subMchId, String transactionID, String outTradeNo, String deviceInfo, String outRefundNo, int totalFee, int refundFee, String opUserID, String refundFeeType) {
